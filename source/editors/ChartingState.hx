...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var player4DropDown = new FlxUIDropDownMenuCustom(player2DropDown.x + 140, player2DropDown.y, FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
		{
		...
		var difficultyDropDown = new FlxUIDropDownMenuCustom(stageDropDown.x, player1DropDown.y + 40,
			FlxUIDropDownMenuCustom.makeStrIdLabelArray(CoolUtil.defaultDifficulties, true), function(difficulty:String)
		{
			PlayState.storyDifficulty = 0;
			try
			{
				PlayState.SONG = Song.loadFromJson(_song.song.toLowerCase() + '-' + difficulty, _song.song.toLowerCase());
				MusicBeatState.resetState();
			}
			catch (e:Any)
			{
	...
	function addChartingUI() {
		...
		#if !html5
		sliderRate = new FlxUISlider(this, 'playbackSpeed', 120, 120, 0.1, 10, 150, null, 5, FlxColor.WHITE, FlxColor.BLACK);
	...
	function updateHeads():Void
	{
		...
		if (_song.notes[curSec].mustHitSection)
		{
			...
			if (_song.notes[curSec].exSection) leftIcon.changeIcon(healthIconP4);
		}
		else
		{
