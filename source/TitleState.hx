...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		FlxG.save.bind('vsmattwiik4', 'z11gaming');
	...
	function startIntro()
	{
		...
		logoBl.animation.addByPrefix('bump', 'Bumpin', 24, false);
		...
		var path = "mods/" + Paths.currentModDirectory + "/images/enter.png";
		//trace(path, FileSystem.exists(path));
		if (!FileSystem.exists(path)){
			path = "mods/images/enter.png";
		}
		//trace(path, FileSystem.exists(path));
		if (!FileSystem.exists(path)){
