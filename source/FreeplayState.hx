...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		scoreText.setFormat(Paths.font("FOT-RodinWanpaku Pro EB.otf"), 32, FlxColor.WHITE, RIGHT);
		...
		text.setFormat(Paths.font("FOT-RodinWanpaku Pro EB.otf"), size, FlxColor.WHITE, RIGHT);
